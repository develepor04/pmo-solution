...
if (Test-Path ".env") {
    ...
    if (Test-Path ".env.example") {
        ...
        Write-Host "  ✓ .env file created from .env.example — add your API keys before starting" -ForegroundColor Green
    } else {
        Write-Host "  ✗ .env.example missing — create .env manually with your credentials" -ForegroundColor Red
    }
}
